...
/**
 * Full route map for apps/main (lunim.io).
...
/**
 * Route map for apps/ai (ai.lunim.io).
...
/**
 * Route map for apps/ux (ux.lunim.io).
 */
...
/**
 * Route map for apps/video (video-next.lunim.io).
 */
 ...
 * import { createPrismicClientFactory, mainRoutes } from "@lunim/prismic/client";
