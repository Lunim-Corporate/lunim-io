...
> = {
  main: {
    ...
    title: "Lunim.io",
    description:
      "Lunim.io creates seamless digital experiences with cutting-edge technology and design.",
    baseUrl: process.env.NEXT_PUBLIC_WEBSITE_URL || "https://lunim.io",
    homePath: "/",
  },
  ai: {
    siteName: "Lunim AI Automation",
    title: "Lunim AI Automation",
    description:
      "Transform your business with AI automation solutions from Lunim.",
    baseUrl: "https://ai.lunim.io",
    homePath: "/",
  ...
  ux: {
    siteName: "Lunim UX",
    title: "Lunim UX",
    description: "Design better product experiences with Lunim UX.",
    baseUrl: "https://ux.lunim.io",
    homePath: "/",
    domain: "ux",
  },
  video: {
    siteName: "Lunim Video Production",
    title: "Lunim Video Production",
    description:
      "Create compelling visual stories with professional video production from Lunim.",
    baseUrl: "https://video-next.lunim.io",
    homePath: "/",
    domain: "video",
  },
};
