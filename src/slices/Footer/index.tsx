            ...
            <ul className="space-y-3">
              {links.map((item, index) => (
                <li key={index}>
                  <PrismicNextLink
                    field={item.link}
                    className="text-gray-400 hover:text-cyan-400 transition-colors duration-300 flex items-center group no-underline"
                  >
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <Link
                  ...
                  className="text-gray-400 hover:text-cyan-400 transition-colors duration-300 no-underline"
                >
                  {company_email}
                </Link>
              </div>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-6">
            <PrismicNextLink
              ...
              className="text-gray-500 hover:text-cyan-400 text-sm transition-colors duration-300 flex items-center no-underline"
            >
