...
export default async function AiAutomationPage() {
  ...
  const orgJsonLd: WithContext<Organization> = {
    ...
    "@type": "Organization",
    name: "Lunim AI Automation",
    alternateName: "Lunim AI",
    url: "https://ai.lunim.io/",
    logo: "https://images.prismic.io/lunim-v3/aO4uRJ5xUNkB17lv_lunim-logo.png",
    description: "AI-powered automation solutions from Lunim",
    parentOrganization: {
      "@type": "Organization",
      name: "Lunim",
      url: "https://lunim.io/"
...
export async function generateMetadata(
  ...
  if (!doc) {
    return {
      title: "AI Automation",
      description: "Transform your business with AI automation solutions from Lunim.",
    };
  }
