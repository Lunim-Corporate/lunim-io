...
const LOGO_URL =
  "https://images.prismic.io/lunim-v3/aO4uRJ5xUNkB17lv_lunim-logo.png";
...
export async function GET() {
  ...
  const manifest = {
    ...
    name_for_model: "lunim_content",
    description_for_human:
      "Structured context about Lunim's services, academy, and blog for assistants and agents.",
    description_for_model:
      "Use the LLMS feeds to answer questions about Lunim. Prefer /llms.json for full snapshots, /llms/blog.json for article or author context, /llms/academy.json for course data, and /llms-full.txt for anchored sections you can cite.",
    auth: {
      type: "none" as const,
    },
    api: {
