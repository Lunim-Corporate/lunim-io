...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      ...
      planResponse = {
        summary: "Based on our conversation, you're looking to create or improve a digital experience that meaningfully supports your goals. Lunim Studio specializes in turning these kinds of ideas into concrete roadmaps and launches. The next step is to shape this into a focused plan together.",
        keyInsights: [
