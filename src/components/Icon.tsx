...
export default function Icon({ icon }: { icon: Simplify<BlogPostDocumentDataIconsItem> }) {
    ...
    if (icon.icon_text?.toLowerCase() === "x") {
        return (
            <PrismicNextLink field={icon.icon_link} className="hover:text-[#1f2937] transition-colors duration-200">
    ...
    if (icon.icon_text?.toLowerCase() === "linkedin") {
        return (
        <PrismicNextLink field={icon.icon_link} className="hover:text-[#1f2937] transition-colors duration-200">
    ...
    if (icon.icon_text?.toLowerCase() === "mail") {
        return (
            <PrismicNextLink field={icon.icon_link} className="hover:text-[#1f2937] transition-colors duration-200">
