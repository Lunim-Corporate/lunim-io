...
import { supabaseServer } from "@lunim/lib/supabase";
import { QuizResultEmail } from "@lunim/ui/emails/QuizResultEmail";
...
export async function POST(request: Request) {
  try {
    ...
    const fromEmail = process.env.RESEND_FROM_EMAIL || "noreply@updates.lunim.io";
    const toolkitLink = process.env.TOOLKIT_DOWNLOAD_LINK || "https://lunim.io/ai-toolkit";
